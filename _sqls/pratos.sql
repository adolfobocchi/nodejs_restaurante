INSERT INTO public.churras_prato(
        nome_prato, ingredientes, modo_preparo, tempo_preparo, rendimento, categoria, date_prato)
	VALUES 	
        ('Picanha','Carvão em brasa, Picanha maturada e Sal Grosso','Considerada por muitos como a mais nobre e procurada carne de churrasco, a picanha pode ser servida ao ponto , mal passada ou bem passada. Suculenta e com sua característica capa de gordura',30,3,'Churrasco','2022-01-30 21:04:31-03'),
        ('Apfelstrudel','Massa folheada, Maçã, Canela e Sorvete','Sobremesa tradicional austro-germânica e um delicioso folhado de maça e canela com sorvete',40,2,'Sobremesa','2022-01-30 21:05:50-03'),
        ('Picanha ao alho','Carvão em brasa, Picanha maturada, alho e Sal Grosso','Esta e a combinação do sabor inconfundível da picanha com o aroma acentuado do alho. Condimento que casa perfeitamente com este corte nobre', 40,2,'Churrasco','2022-01-30 21:05:50-03'),
